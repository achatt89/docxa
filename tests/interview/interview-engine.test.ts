...
import { InterviewSessionStore } from '../../src/interview/interview-session-store.js';
...
describe('InterviewEngine', () => {
    ...
    const mockDefinition: InterviewDefinition = {
        ...
        questions: [
            ...
            { id: 'q2', sectionId: 's2', question: 'Q2?', answerType: 'long_text', required: true, dependsOn: ['q1'] }
        ]
    };
