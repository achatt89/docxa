...
describe('InterviewTemplateAlignment', () => {
    ...
    it('should pass for valid section IDs', () => {
        const interview: InterviewDefinition = {
            ...
            purpose: 'test',
            questions: [
                { id: 'q1', sectionId: 'overview', question: 'Q1', answerType: 'long_text', required: true },
    ...
    it('should throw error for invalid section IDs', () => {
        const interview: InterviewDefinition = {
            ...
            purpose: 'test',
            questions: [
                { id: 'q1', sectionId: 'invalid_section', question: 'Q1', answerType: 'long_text', required: true }
            ]
        };

        expect(() => InterviewTemplateAlignment.validate(interview, mockTemplate)).toThrow(/do not exist in the PRD template: invalid_section/);
    });
    ...
    it('should show all invalid section IDs and valid ones in error message', () => {
        ...
        expect(() => InterviewTemplateAlignment.validate(interview, mockTemplate)).toThrow(/bad1, bad2/);
        expect(() => InterviewTemplateAlignment.validate(interview, mockTemplate)).toThrow(/Valid sectionIds for PRD are: overview, features/);
    });
});
