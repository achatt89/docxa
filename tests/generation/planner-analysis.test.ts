...
describe('GenerationPlanner with Analysis Evidence', () => {
    ...
    it('should satisfy functional_context if frameworks analysis is available', () => {
        ...
        expect(report.alternativeEvidenceUsed.some(e => e.includes('Repo Analysis: frameworks'))).toBe(true);
    });
    ...
    it('should satisfy architecture_context if architecture analysis is available', () => {
        ...
        expect(report.alternativeEvidenceUsed.some(e => e.includes('Repo Analysis: architecture'))).toBe(true);
    });
    ...
    it('should suggest docxa discover if analysis evidence is missing', () => {
        ...
        expect(report.suggestions.some(s => s.includes("docxa discover") && s.includes("frameworks"))).toBe(true);
    });
});
